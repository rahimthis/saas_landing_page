...
const Hero = () => {
  return (
    <div
      className="m-auto grid max-w-7xl grid-cols-[5fr_4fr] items-center gap-x-18 px-6 lg:px-0 py-42
      max-xl:grid-cols-2 max-xl:gap-x-12  max-xl:py-38  max-lg:py-32 max-md:grid-cols-1 max-md:grid-rows-[repeat(2,auto)] max-md:gap-y-12 max-md:py-24"
    >
      {/* Left Content */}
      <div>
        ...
        <p
          className="text-primary-100 mb-10 text-xl/loose font-light
          max-xl:mb-8 max-xl:text-lg/8
          max-lg:text-base/loose"
        >
        ...
        <button
          className="text-primary-1300 bg-primary-500 border-primary-500 hover:border-primary-50 hover:bg-primary-50 
            transition-properties primary-glow-hover primary-glow group flex cursor-pointer items-center gap-x-3 rounded-full 
            border-2 px-8 py-3.5 max-xl:gap-x-2 max-xl:px-6 max-xl:py-3"
        >
          ...
          <div className="w-5 max-xl:w-4 max-sm:hidden">
            <ArrowRightLine
              ...
              className="stroke-primary-1300 transition-properties -mr-3 inline w-0 opacity-0 ease-in-out 
      ...
      <div className="relative">
        ...
        <img
          ...
          className="relative max-h-[30rem] justify-self-end
            max-md:max-h-auto max-md:max-w-[90%] max-md:justify-self-center max-sm:max-w-full"
        />
      </div>
    </div>
  );
